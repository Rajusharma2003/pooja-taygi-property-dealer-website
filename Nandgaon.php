...
$sql = "SELECT * FROM properties WHERE city = 'Nandgaon'";
...
<body>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <ul class="dropdown-menu" aria-labelledby="productDropdown">
              ...
              <li><a class="dropdown-item" href="#">Nandgaon</a></li>
            </ul>
            </li>
            <li class="nav-item">
    ...
    <!-- End Navbar section -->
     ...
     <!-- <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-dark mb-3 animated slideInDown mx-auto">Product</h1>
    ...
    <section class="image-section">
        <img src="img/7.jpg" alt="Cooking Products" class="w-100" />
      </section>
